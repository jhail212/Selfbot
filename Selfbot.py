...
import youtube_dl
#cl = LineClient()
cl = LineClient(authToken='EDDqRb2tDiAymSNkuaw6.i5S7ZXoJSpRPulLmxRl5XG.AxTgHt6R2xFU0BsqLm5/HT+X6cnxP5vrs2Y6sAGZCDw=')
...
wait = {
    ...
    "selfbot":True,
    "unsend":False,
    "mention":"\n╭─────────────╮\n│•ᴍᴀᴜ sᴀᴍᴘᴇᴋ ᴋᴀᴘᴀɴ \n│•ᴊᴀᴅɪ ᴛᴜᴋᴀɴɢ ɪɴᴛɪᴘ  ɢɪᴛᴜ...\n│•ɢᴀʙᴜɴɢ sɪɴɪ ʙɪᴀʀ ᴋᴇʟɪʜᴀᴛᴀɴ \n│•ᴀɢᴀᴋ ᴋᴇᴋɪɴɪᴀɴ... 😊\n╰─────────────╯",
...
⏩by:"✦ᴊʜᴀɪʟ ʙ❍ᴛs™
           ✦line.me/ti/p/~jhail___id"""
    return helpMessage2
def listharga():
    helpMessage3 = """
#Price List ᴊʜᴀɪʟ ʙ❍ᴛs:
...
Chat Ke : http://line.me/ti/p/~jhail___id
...
#UPDATE FOTO
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                timeNow = datetime.now(tz=tz)
                                md = "▬▬▬▬▬▬▬▬▬▬▬▬\n          🔰 S T A T U S 🔰\n▬▬▬▬▬▬▬▬▬▬▬▬\n"
                                if wait["unsend"] == True: md+="🔊 「ON」Unsend\n"
                                else: md+="🔇 「OFF」Unsend\n"
                                if wait["sticker"] == True: md+="🔊 「ON」Sticker\n"
                                else: md+="🔇 「OFF」Sticker\n"
                                if wait["contact"] == True: md+="🔊 「ON」Contact\n"
                                else: md+="🔇 「OFF」Contact\n"
                                if wait["Mentionkick"] == True: md+="🔊 「ON」Notag\n"
                                else: md+="🔇 「OFF」Notag\n"
                                if wait["detectMention"] == True: md+="🔊 「ON」Respon\n"
                                else: md+="🔇 「OFF」Respon\n"
                                if wait["Mentiongift"] == True: md+="🔊 「ON」Respongift\n"
                                else: md+="🔇 「OFF」Respongift\n"
                                if wait["autoJoin"] == True: md+="🔊 「ON」Autojoin\n"
                                else: md+="🔇 「OFF」Autojoin\n"
                                if settings["autoJoinTicket"] == True: md+="🔊 「ON」Join Ticket\n"
                                else: md+="🔇 「OFF」Join Ticket\n"
                                if msg.to in simisimi: md+="🔊 「ON」Simisimi\n"
                                else: md+="🔇 「OFF」Simi\n"
                        ...
                        elif cmd == "status trans":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
                                md = "▬▬▬▬▬▬▬▬▬▬▬▬\n🔰 STATUS TRANSLATE 🔰\n▬▬▬▬▬▬▬▬▬▬▬▬\n"
                                if msg.to in translatetr: md+="🔊 「ON」Turkish\n"
                                else: md+="🔇 「OFF」Turkish \n"
                                if msg.to in translateen: md+="🔊 「ON」English\n"
                                else: md+="🔇 「OFF」English\n"
                                if msg.to in translateid: md+="🔊 「ON」Indonesia\n"
                                else: md+="🔇 「OFF」Indonesia\n"
                                if msg.to in translateth: md+="🔊 「ON」Thailand\n"
                                else: md+="🔇 「OFF」Thailand\n"
                                if msg.to in translatetw: md+="🔊 「ON」Taiwan\n"
                                else: md+="🔇 「OFF」Taiwan\n"
                                if msg.to in translatear: md+="🔊 「ON」Arab\n"
                                else: md+="🔇 「OFF」Arab\n"
                                cl.sendMessage(msg.to, md+"▬▬▬▬▬▬▬▬▬▬▬▬\n◈Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n◈Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]\n▬▬▬▬▬▬▬▬▬▬▬▬")
                        ...
                        elif cmd == "iam" or text.lower() == 'aku':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               msg.contentType = 13
 ...
 #                              cl.sendMessage(msg.to, None,contentMetadata={'mid': sender}, contentType=13)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               try:
                                   ...
                                   cl.sendMessage(msg.to, "╭━━━━━━━━━━━━━━━━━━━━\n┣━[ Mantan berhasih di buang ke laut bozz.\n╰━━━━━━━━━━━━━━━━━━━━")
                               except:
                                   pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               Setmain["namecreator"] = "ᴊʜᴀɪʟ ʙ❍ᴛs™"
...
#===========BOT UPDATE============#
                        elif cmd == "tagall" or text.lower() == 'mentil':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
...
#===========Protection============#
                          ...
                          if msg._from in admin:
                           if msg.toType == 2:
                            ...
                            if wait["lang"] == "JP":
                                cl.sendText(msg.to,"✔ ᴅ❍ɴᴇ\n Success menolak semua undangan")
                            else:
